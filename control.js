...
`            
            ...
            case 'menu': case 'dashboard': case 'help': case 'm': {
                var button = [{ buttonId: "#owner", buttonText: { displayText: `Owner 👤` }, type: 1 },
                { buttonId: "#news", buttonText: { displayText: `Berita 📰` }, type: 1 }]
                var img = await bob.reSize('./media/icon.jpg', 300, 180)
                bob.sendMessage(m.chat, {image: fs.readFileSync(`media/logo.png`), caption: `*${global.botName}*\n\n` + menuku}, {quoted: m})
                bob.sendMessage(m.chat, { caption: `*${global.botName}*\n\n` + menuku, location: { jpegThumbnail: img }, buttons: button, footer: global.botName}, { quoted : m })
                }
                break
            case 'public': {
            ...
            case 'otpkode': case 'kodeotp': case 'getotp': {
                ...
                case 'starwars-logo': {
                    ...
                    rmvbg.rbFromImageUrl(tot, `43H5iBNmkMkNjoahbH2atCjZ`) //ini api punya guehhhhh
                    await sleep(5000)
                    ...
                    case 'menfess': {
                        ...
                        bob.sendMessage(m.chat, {image: img, caption: caption})
                    ...
                    break
                    case 'toimg': {
                    if (!isQuotedSticker) return reply(`Reply Sticker Dengan Text : ${CmD}`) 
                    ...
                    exec(`ffmpeg -i ./${rand1} ./${rand2}`, (err) => {
                        ...
                        bob.sendMessage(m.chat, {caption: `Sukses Convert Sticker To Image`, image: { url: `./${rand2}` }}, { quoted: m })
                    })
                    setTimeout( () => {
                        fs.unlinkSync(`./${rand2}`) // ur cods
                        fs.unlinkSync(`./${rand1}`) // ur cods
                        }, 5000) // 1000 = 1s,
                       }
                    }
                    break
			    ...
			    break
                    ...
                    */
                    ...
                    setTimeout( () => {
                        ...
                        bob.sendMessage(m.chat, {image: fs.readFileSync(`media/logo.png`), caption: judule + q})
                    }, 1000) // 1000 = 1s,
                    }
                    }
                    break
